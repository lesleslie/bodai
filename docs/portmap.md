...
1. **Memorable Pattern**: The 86xx pattern is easy to remember and type:
   ...
   - 8683 = Dhara (3 for "Curator" - third pillar)
...
| Core Services | 868x | Mahavishnu (8680), Akosha (8682), Dhara (8683) |
...
sudo ufw allow 8683/tcp comment 'Dhara'
```
...
| Dhara | 8683 | `http://localhost:8683/health` |
